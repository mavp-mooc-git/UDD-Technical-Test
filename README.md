...
#### Notas
Crear un repo nuevo público en tu GitHub y sube ahí tu proyecto, así mismo, graba en un [Loom](https://www.loom.com/) la explicación de la construcción de tu proyecto realizado, te invito a ser lo más clar@ posible, ambas cosas (proyecto y video) enviámelos al siguiente correo < ana.osorio@scalalearning.com > una vez que hayas terminado.
